...
function Settings() {
  ...
  const onSubmit = (data) => {
    if (bankInfo) {
      ...
      axios.put(`https://dream-records-2025-m2m9a.ondigitalocean.app/api/v1/bank-info/${bankInfo._id}`,payloadData)
      .then((res) => {
        if (res.status === 200) {
      ...
      axios.post(`https://dream-records-2025-m2m9a.ondigitalocean.app/api/v1/bank-info`,payloadData)
      .then((res) => {
        if (res.status === 200) {
          toast.success(res.data.message);
          setBankInfoReFetch(bankInfoReFetch + 1);
        ...
        <div className="settings-div">
          ...
          {bankInfo && (
            ...
            >
              ...
              {/* Save Button */}
              {
                notBankInfo ? <button type="submit" className="settings-save-btn">Edit</button> : <button type="submit" className="settings-save-btn">Save</button>
              }
            </form>
          )}
        </div>
